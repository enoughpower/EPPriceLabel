...
@interface CMTickerCharacterLabel : UILabel
...
@implementation CMTickerCharacterLabel
...
- (void)selectCharacter:(NSString *)selectedCharacter
               animated:(BOOL)animated
{
    if (self.scrollDirection == CMTickerLabelScrollDirectionUp)
    {
        ...
        else if ([selectedCharacter isEqualToString: @","]) {
...
@implementation CMTickerLabelView
...
- (void)insertNewCharacterLabel
{
    ...
    if (self.scrollDirection == CMTickerLabelScrollDirectionDown)
    {
    ...
    CMTickerCharacterLabel *characterLabel = [[CMTickerCharacterLabel alloc] initWithFrame: characterFrame];
...
{
    CMTickerCharacterLabel *numericView = [self.characterViewsArray lastObject];
    [numericView removeFromSuperview];
}

#pragma mark Interface

- (void)setScrollDirection:(CMTickerLabelScrollDirection)direction
{
    if (direction != _scrollDirection)
    {
        ...
        if (direction == CMTickerLabelScrollDirectionDown)
        {
        ...
        [self.characterViewsArray enumerateObjectsUsingBlock:
         ^(CMTickerCharacterLabel* label, NSUInteger idx, BOOL *stop)
         {
...
{
    CGRect characterFrame = CGRectZero;
    for (CMTickerCharacterLabel* label in self.characterViewsArray)
    {
